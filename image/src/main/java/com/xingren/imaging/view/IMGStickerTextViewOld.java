...
import com.xingren.imaging.IMGTextEditDialog;
 ...
 */
@Deprecated
public class IMGStickerTextViewOld extends FrameLayout implements IMGSticker,
        View.OnClickListener, IMGTextEditDialog.Callback {
    ...
    private IMGStickerHelper<IMGStickerTextViewOld> mStickerHelper;

    private static final Paint PAINT;

    private static final int PADDING = 26;

    private static final int SIZE_OP = 48;
    ...
    public IMGStickerTextViewOld(Context context) {
        this(context, null, 0);
    }

    public IMGStickerTextViewOld(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IMGStickerTextViewOld(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setScaleX(float scaleX) {
        super.setScaleX(Math.min(scaleX, 8f));
    }

    @Override
    public void setScaleY(float scaleY) {
        super.setScaleY(Math.min(scaleY, 8f));
    }
